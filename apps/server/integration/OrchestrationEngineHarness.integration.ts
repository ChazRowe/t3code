...
import { makeBackgroundWorkLedgerLive } from "../src/orchestration/Layers/BackgroundWorkLedger.ts";
import {
  OrchestrationEngineService,
  type OrchestrationEngineShape,
} from "../src/orchestration/Services/OrchestrationEngine.ts";
import { ThreadDeletionReactor } from "../src/orchestration/Services/ThreadDeletionReactor.ts";
import { UnattendedRunReactor } from "../src/orchestration/Services/UnattendedRunReactor.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const orchestrationReactorLayer = OrchestrationReactorLive.pipe(
      ...
      Layer.provideMerge(
        Layer.succeed(UnattendedRunReactor, {
          start: () => Effect.void,
          drain: Effect.void,
        }),
      ),
